...
print(x * 2)  # Mu l t i p l i c a t i o n ; prints "6"
print(x ** 2)  # Ex p o n e n t i a t i o n ; prints "9"
x += 1
print(x)  # Prints "4"
x *= 2
print(x)  # Prints "8"
...
hw = hello + "" + world  # String c onc at ena ti on
print(hw)  # prints " hello world "
hw12 = "%s%s%d" % (hello, world, 12)  # sprintf style string formatting
print(hw12,"x")  # prints " hello world 12 "
